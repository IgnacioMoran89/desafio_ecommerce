...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { amount: @coupon.amount, code: @coupon.code, count: @coupon.count, discount: @coupon.discount, type: @coupon.type, user_id: @coupon.user_id } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { amount: @coupon.amount, code: @coupon.code, count: @coupon.count, discount: @coupon.discount, type: @coupon.type, user_id: @coupon.user_id } }
